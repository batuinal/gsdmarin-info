/*function displayTime(id, id2){
    ...
    var newdate = new Date(utc + (2*360000));

    
    document.getElementById(id).innerHTML = 'Local Time: ' + h_local + ':' + m_local + ':' + s_local;
    setTimeout(displayTime,1000,id,id2);
}*/
